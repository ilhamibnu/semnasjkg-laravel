...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12">
            <h2 class="mb-2 page-title">Data Group</h2>
                                        ...
                                        <div class="modal fade" id="deleteModal{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="defaultModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="/group/{{ $data->id }}" method="post">
                                                        @csrf
                                                        @method('delete')
                                                    ...
                                                    <form action="/group/{{ $data->id }}" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ $data->link }}" name="link" class="form-control" id="recipient-name" required>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="status" class="form-control" id="example-select" required>
                                                                    ...
                                                                    <option selected value="tersedia">
                                                                        Tersedia</option>
                                                                    @else
                                                                    <option value="penuh">
                                                                        Penuh</option>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="example-select">Semnas</label>
                                                                <select name="id_semnas" class="form-control" id="example-select" required>
                                                                    <option selected value="{{ $data->semnas->id }}">{{ $data->semnas->name }}</option>
                                                                    @foreach($datasemnas as $semnas)
                                                                    <option value="{{ $semnas->id }}">{{ $semnas->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="modal-body">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="" name="link" class="form-control" id="recipient-name" required>
                                                        </div>
