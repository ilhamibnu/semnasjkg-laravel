...
@section('title', 'Data User JKG Surabaya')

@section('content')
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12">
            <h2 class="mb-2 page-title">Data User JKG Surabaya</h2>
                            ...
                            <div class="table-responsive">
                                <table class="table datatables table-hover responsive nowrap" style="width:100%" id="dataTable-1">
                                    <div class="align-right text-right mb-3">
                                        ...
                                        <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#importModal">Import Excel</button>
                                    </div>
                                        ...
                                        <div class="modal fade" id="deleteModal{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="defaultModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="/userjkg/{{ $data->id }}" method="post">
                                                        @csrf
                                                        @method('delete')
                                ...
                                <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="defaultModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="/userjkg" method="POST">
                                                @csrf
                                                @method('POST')
                                                <div class="modal-body">
