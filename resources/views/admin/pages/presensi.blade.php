...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12">
            <h2 class="mb-2 page-title">Data Presensi</h2>
                                        ...
                                        <div class="modal fade" id="deleteModal{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="defaultModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="/presensi2/{{ $data->id }}" method="post">
                                                        @csrf
                                                        @method('delete')
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="form-group col-md-8">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control drgpicker" name="datemulai" id="date-input1" value="04/24/2020" aria-describedby="button-addon2">
                                                                    ...
                                                                    <div class="form-group col-md-4">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control time-input" name="timemulai" id="time-input2" placeholder="" aria-describedby="button-addon2">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="anjay">
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="form-group col-md-8">
                                                                        <label for="date-input1">Date Picker</label>
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control drgpicker" name="dateselesai" id="date-input1" value="04/24/2020" aria-describedby="button-addon2">
                                                                            <div class="input-group-append">
                                                                                <div class="input-group-text" id="button-addon-date"><span class="fe fe-calendar fe-16"></span></div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group col-md-4">
                                                                        <label for="time-input2">Time Picker</label>
                                                                        <div class="input-group">
                                                                            <input type="text" class="form-control time-input" name="timeselesai" id="time-input2" placeholder="" aria-describedby="button-addon2">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="defaultModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="/presensi2" method="POST">
                                                @csrf
                                                @method('POST')
                                                <div class="modal-body">
