...
@section('title', 'Data Serifikat')

@section('content')
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12">
            <h2 class="mb-2 page-title">Data Sertifikat</h2>
                                ...
                                <table class="table datatables table-hover responsive nowrap" style="width:100%" id="dataTable-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $no++ }}</td>
                                            <td>{{ $data->name }}</td>
                                            <td> <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#linkModal{{ $data->id }}">Detail</button></td>
                                            <td>{{ $data->status }}</td>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" id="example-textarea" rows="4">{{ $data->link }}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <form action="/sertifikat/{{ $data->id }}" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" name="link" id="example-textarea" rows="4">{{ $data->link }}</textarea>
                                                            </div>
                                            ...
                                            <form action="/sertifikat" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="link" id="example-textarea" rows="4"></textarea>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="example-select">Status</label>
                                                        <select name="status" class="form-control" id="example-select" required>
                                                            <option value="" disabled selected>Pilih Statis</option>
                                                            <option value="aktif">
                                                                Aktif</option>
                                                            <option value="tidak_aktif">
                                                                Tidak Aktif</option>
