...
@section('title', 'Data Semnas')

@section('content')
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12">
            <h2 class="mb-2 page-title">Data Semnas</h2>
                                ...
                                <table class="table datatables table-hover responsive nowrap" style="width:100%" id="dataTable-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $data->harga }}</td>
                                            <td>
                                                <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#deskripsiModal{{ $data->id }}">Detail</button>
                                            </td>
                                            <td>{{ $data->jenis_peserta->name }}</td>
                                        ...
                                        <!-- Deskripsi Modal -->
                                        <div class="modal fade" id="deskripsiModal{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="defaultModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal fade" id="deleteModal{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="defaultModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="/semnas/{{ $data->id }}" method="post">
                                                        @csrf
                                                        @method('delete')
                                                        <div class="modal-footer">
                                                    ...
                                                    <form action="/semnas/{{ $data->id }}" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" value="{{ $data->harga }}" name="harga" class="form-control" id="recipient-name" required>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="example-select">Jenis Peserta</label>
                                                                <select name="id_jenis_peserta" class="form-control" id="example-select" required>

                                                                    <option selected value="{{ $data->id_jenis_peserta }}">{{ $data->jenis_peserta->name }}</option>
                                ...
                                <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="defaultModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="/semnas" method="POST">
                                                @csrf
                                                @method('POST')
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="id_jenis_peserta" class="form-control" id="example-select" required>
                                                            ...
                                                            <option disabled selected value="">Pilih Jenis Peserta</option>
