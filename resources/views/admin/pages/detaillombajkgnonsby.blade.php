...
@section('title', 'Data Lomba JKG Non Surabaya')

@section('content')
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12">
            <h2 class="mb-2 page-title">Data Lomba JKG Non Surabaya</h2>
                                ...
                                <table class="table datatables table-hover responsive nowrap" style="width:100%" id="dataTable-1">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Name</th>
                                            <th>Lomba</th>
                                            <th>Link Pengumpulan Lomba</th>
                                            <th>Link Pengumpulan KTM</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @php
                                        $no = 1;
                                        @endphp
                                        @foreach($datadetaillomba as $data)
                                        <tr>
                                            <td>{{ $no++ }}</td>
                                            <td>{{ $data->name }}</td>
                                            <td>{{ $data->lomba}}</td>
                                            <td>
                                                @if($data->link_pengumpulan == '')
                                                <p>belum ngumpulin</p>
                                                @else
                                                <a class="btn btn-success btn-sm" href="{{ $data->link_pengumpulan }}" target="_blank">Link Pengumpulan</a>
                                                @endif
                                            </td>
                                            <td>
                                                @if($data->link_pengumpulan_ktm == '')
                                                <p>belum ngumpulin</p>
                                                @else
                                                <a class="btn btn-success btn-sm" href="{{ $data->link_pengumpulan_ktm }}" target="_blank">Link Pengumpulan KTM</a>
                                                @endif
                                            </td>
                                        </tr>
