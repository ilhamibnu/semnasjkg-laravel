!(function (t, e) {
    ...
    Object.keys(d).forEach(function (o) {
        ...
        Object.keys(s).forEach(function (t) {
            ...
            (h[o][t] =
                ("conversion" in (a = n) && (r.conversion = a.conversion), r)),
                (h[o][t].raw =
                    ("conversion" in (e = n) && (i.conversion = e.conversion),
                    i));
        });
    });
    var c = h,
        ...
        z = {
            ...
            _parseFont: function (t) {
                ...
                return (
                    (a.string =
                        !(e = a) ||
                        w.isNullOrUndef(e.size) ||
                        w.isNullOrUndef(e.family)
                            ? null
                            : (e.style ? e.style + " " : "") +
                              (e.weight ? e.weight + " " : "") +
                              e.size +
    ...
    W.extend(U.prototype, {
        ...
        pivot: function () {
            var t = this;
            return (
                t._view || (t._view = W.extend({}, t._model)),
                (t._start = {}),
                t
            );
        },
                ...
                (!1 !==
                    (e =
                        i && void 0 === t
                            ...
                            : ((t = t || 0),
                              this._resolveDataElementOptions(
                                  n.data[t] || {},
                                  t
                              ))).fill &&
                    null !== e.fill) ||
        ...
        _resolveDatasetElementOptions: function (t, e) {
            for (
                var n,
                    ...
                    l =
                        r.options.elements[
                            a.datasetElementType.prototype._type
                        ] || {},
                ...
                (n = d[c]),
                    (i = e
                        ? "hover" + n.charAt(0).toUpperCase() + n.slice(1)
                        : n),
                    (u[n] = Z([s[i], o[i], l[i]], h));
            return u;
        },
                ...
                if (s.length) {
                    ...
                    for (
                        r.save(),
                            ...
                            r.setLineDash &&
                                r.setLineDash(a.borderDash || d.borderDash),
                            r.lineDashOffset = at(
                                a.borderDashOffset,
                                d.borderDashOffset
                            ),
    ...
    var wt = tt.extend({
                ...
                if (v || (void 0 === v && void 0 !== b))
                    for (i = 0; i < _ && (a = g[i]).index !== t; ++i)
                        a.stack === b &&
                            ((r =
                                void 0 ===
                                (d = h._parseValue(f[a.index].data[e])).start
                                    ? d.end
                                    : 0 <= d.min && 0 <= d.max
                                    ? d.max
                                    : d.min),
                            ((p.min < 0 && r < 0) || (0 <= p.max && 0 < r)) &&
                                (x += r));
                return (
            ...
            _resolveDataElementOptions: function () {
                var t = W.extend(
                        {},
                        tt.prototype._resolveDataElementOptions.apply(
                            this,
                            arguments
                        )
                    ),
    ...
    var Ct = tt.extend({
            ...
            _resolveDataElementOptions: function (t, e) {
                var n = this,
                    ...
                    r = t.custom || {},
                    o = a.data[e] || {},
                    s = tt.prototype._resolveDataElementOptions.apply(
                        n,
                        arguments
                    ),
                    l = {
            ...
            callbacks: {
                ...
                label: function (t, e) {
                    var n = e.labels[t.index],
                        i = ": " + e.datasets[t.datasetIndex].data[t.index];
                    return (
                        W.isArray(n) ? ((n = n.slice())[0] += i) : (n += i), n
                    );
                },
            },
        },
        ...
        update: function (t) {
            ...
            for (
                x.borderWidth = b.getMaxBorderWidth(),
                    ...
                    b.outerRadius =
                        x.outerRadius -
                        x.radiusLength * b._getRingWeightOffset(b.index),
                    b.innerRadius = Math.max(
                        b.outerRadius - x.radiusLength * T,
                        0
                    ),
                    i = 0,
                    a = P.length;
            ...
            for (e = 0, n = t.length; e < n; ++e)
                (a = t[e]),
                    "inner" !==
                        (o = r
                            ? (r._configure(),
                              r._resolveDataElementOptions(a, e))
                            : a._options).borderAlign &&
                        ((s = o.borderWidth),
                        (d =
                            (l = o.hoverBorderWidth) > (d = d < s ? s : d)
                                ? l
                                : d));
            return d;
        },
    ...
    var Nt = tt.extend({
            ...
            _resolveDatasetElementOptions: function (t) {
                var e,
                    ...
                    p = c.chart.options,
                    m = p.elements.line,
                    v = tt.prototype._resolveDatasetElementOptions.apply(
                        c,
                        arguments
                    );
                return (
        ...
        legend: {
            ...
            onClick: function (t, e) {
                for (
                    ...
                    (n = a.getDatasetMeta(r)).data[i].hidden =
                        !n.data[i].hidden;
                a.update();
            },
        },
    ...
    var Ht = tt.extend({
        ...
        _resolveDatasetElementOptions: function () {
            var t = this._config,
                ...
                n = tt.prototype._resolveDatasetElementOptions.apply(
                    this,
                    arguments
                );
            return (
        ...
        var t,
            ...
            h = (u.resizer = (function (t) {
                ...
                ((r = !(t = function () {
                    ...
                    u.resizer &&
                        ((e = (t =
                            a.options.maintainAspectRatio && n.parentNode)
                            ? t.clientWidth
                            : 0),
                        i(me("resize", a)),
                        t &&
        ...
        nearest: function (t, e) {
            for (
                ...
                h &&
                    h.hasValue() &&
                    ((d = h.getCenterPoint()),
                    (u = W.distanceBetweenPoints(e, d)) < o &&
                        ((o = u), (n = h)));
            }
            return (
                n && ((a = (i = n.tooltipPosition()).x), (r = i.y)),
                { x: a, y: r }
            );
        },
    };
    function Pe(t, e) {
        return (
            e && (W.isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
            t
        );
    }
    function Ae(t) {
                ...
                w.filter &&
                    ...
                    W.each(O, function (t) {
                        F.push(w.callbacks.labelColor.call(k, t, k._chart)),
                            L.push(
                                w.callbacks.labelTextColor.call(k, t, k._chart)
                            );
                    }),
                    ...
                    (h = A =
                        (function (t, e) {
                            ...
                            n(i.x)
                                ? ((o = "left"),
                                  h(i.x) && ((o = "center"), (s = f(i.y))))
                                : u(i.x) &&
                                  ((o = "right"),
                                  c(i.x) && ((o = "center"), (s = f(i.y))));
                            var g = t._options;
                            return {
    ...
    W.extend(Ee.prototype, {
        ...
        updateDataset: function (t) {
            ...
            !1 !== ke.notify(this, "beforeDatasetUpdate", [n]) &&
                ...
                ke.notify(this, "afterDatasetUpdate", [n]));
        },
        render: function (t) {
            var e = this;
            (t && "object" == typeof t) ||
        ...
        _getSortedDatasetMetas: function (t) {
            for (
                var e = [], n = 0, i = (this.data.datasets || []).length;
                n < i;
                ++n
            )
                (t && !this.isDatasetVisible(n)) ||
                    e.push(this.getDatasetMeta(n));
        ...
        drawDataset: function (t, e) {
            ...
            !1 !== ke.notify(this, "beforeDatasetDraw", [n]) &&
                (t.controller.draw(e),
                ke.notify(this, "afterDatasetDraw", [n]));
        },
        ...
        updateHoverStyle: function (t, e, n) {
            for (
                var i, a = n ? "set" : "remove", r = 0, o = t.length;
                r < o;
                ++r
            )
                (i = t[r]) &&
    ...
    var en = Y.extend({
        ...
        afterBuildTicks: function (t) {
            ...
            return Ue(t) && t.length
                ...
                : ((e.ticks =
                      W.callback(e.options.afterBuildTicks, [e, e.ticks]) ||
                      e.ticks),
                  t);
        },
        ...
        fit: function () {
            ...
            P ? (x.width = b.maxWidth) : S && (x.width = Ke(M) + Ze(w)),
                ...
                k.display &&
                    ...
                    P
                        ? ((l = 0 !== b.labelRotation),
                          ...
                          (p =
                              b.right -
                              b.getPixelForTick(b.getTicks().length - 1)),
                          (m = l
                              ? ((f = C
                                ...
                                C
                                    ? h * (i.height - i.offset)
                                    : u * i.width + h * i.offset)
                              : ((f = n.width / 2), i.width / 2)),
                          (b.paddingLeft =
                              Math.max(((f - g) * b.width) / (b.width - g), 0) +
                              3),
                          (b.paddingRight =
                              Math.max(((m - p) * b.width) / (b.width - p), 0) +
                              3))
                ...
                P
                    ? ((b.width = b._length =
                          y.width - b.margins.left - b.margins.right),
                      (b.height = x.height))
                    : ((b.width = x.width),
                      (b.height = b._length =
        ...
        _autoSkip: function (t) {
            ...
            if (
                ((i = (function (t, e) {
                    ...
                    for (
                        a = 0, r = (n = W.math._factorize(o)).length - 1;
                        a < r;
                        a++
                    )
                        if ((i = n[a]) > s) return i;
                ...
                for (
                    ...
                    (i = (r = v[b]).width),
                        ...
                        i &&
                            ...
                            f.beginPath(),
                            n.drawTicks &&
                                (f.moveTo(r.tx1, r.ty1),
                                f.lineTo(r.tx2, r.ty2)),
                            n.drawOnChartArea &&
                                (f.moveTo(r.x1, r.y1), f.lineTo(r.x2, r.y2)),
                            f.stroke(),
                            f.restore());
                m &&
                    ((u = m),
                ...
                var p = this,
                    ...
                    n = (p.ticks = (function () {
                        ...
                        (i = Math.ceil(c / f) - Math.floor(h / f)) > s &&
                            ...
                            r &&
                                (!sn(l) &&
                                    W.almostWhole(l / f, f / 1e3) &&
                                    (e = l),
                                !sn(d) &&
                                    W.almostWhole(d / f, f / 1e3) &&
                                    (n = d)),
                            (i = (n - e) / f),
    ...
    var hn = W.valueOrDefault,
        ...
        fn = {
            position: "left",
            ticks: { callback: qe.formatters.logarithmic },
        };
    function gn(t, e) {
            ...
            (t.min = gn(e.min, t.min)),
                ...
                t.min === t.max &&
                    (0 !== t.min && null !== t.min
                        ...
                        : ((t.min = 1), (t.max = 10))),
                null === t.min &&
                    (t.min = Math.pow(10, Math.floor(cn(t.max)) - 1)),
                null === t.max &&
                    (t.max =
                        0 !== t.min
                            ? Math.pow(10, Math.floor(cn(t.min)) + 1)
                            : 10),
                null === t.minNotZero &&
                    (0 < t.min
                        ? (t.minNotZero = t.min)
        ...
        getPixelForValue: function (t) {
            ...
            return (
                (t = +e.getRightValue(t)) > e.min &&
                    0 < t &&
                    (n =
                        (cn(t) - e._startValue) / e._valueRange +
                        e._valueOffset),
        ...
        _drawLabels: function () {
            ...
            l.display &&
                ...
                W.each(o.ticks, function (t, e) {
                    (0 === e && !l.reverse) ||
                        ((n = o.getDistanceFromCenterForValue(
                            o.ticksAsNumbers[e]
                        )),
                        l.showLabelBackdrop &&
            ...
            for (m = 0, v = (o.data.datasets || []).length; m < v; ++m)
                if (o.isDatasetVisible(m))
                    if (((n = o.data.datasets[m].data), W.isObject(n[0])))
                        ...
                        (f[m] = g.slice(0)), a || ((c = c.concat(g)), (a = !0));
                else f[m] = [];
            g.length &&
                ((u = Math.min(u, g[0])), (h = Math.max(h, g[g.length - 1]))),
                c.length &&
                    ((c =
                        1 < v
                            ? (function (t) {
            ...
            return (
                ...
                (h._majorUnit =
                    f.major.enabled && "year" !== h._unit
                        ? (function (t) {
                              for (
                                  var e = Tn.indexOf(t) + 1, n = Tn.length;
                                  e < n;
                                  ++e
                              )
                ...
                (h._table = (function (t, e, n) {
                    ...
                    for (
                        var i, a, r, o = [], s = [e], l = 0, d = t.length;
                        l < d;
                        ++l
                    )
                ...
                (h._offsets =
                    ...
                    c.offset &&
                        ...
                        (s =
                            1 === a.length
                                ? 1 - r
                                : (On(i, "time", a[1], "pos") - r) / 2),
                        (o = On(i, "time", a[a.length - 1], "pos")),
                        (l =
                            1 === a.length
                                ? o
                                : (o - On(i, "time", a[a.length - 2], "pos")) /
                                  2)),
                          ...
                          ? ((i = t.lineWidths = [0]),
                            ...
                            W.each(t.legendItems, function (t, e) {
                                var n =
                                    Kn(h, g) +
                                    g / 2 +
                                    c.measureText(t.text).width;
                                (0 === e ||
                                    i[i.length - 1] + n + 2 * h.padding >
                                        m.width) &&
                                    ((a += g + h.padding),
                                    (i[i.length - (0 < e ? 0 : 1)] = 0)),
                                    (p[e] = {
                                        left: 0,
                                        top: 0,
                                        width: n,
                ...
                W.each(D.legendItems, function (t, e) {
                    ...
                    y.setWidth(D.minSize.width),
                        C
                            ? 0 < e &&
                              ...
                              ((r = P.y += A),
                              P.line++,
                              (a = P.x = D.left + S(R, z[P.line])))
                            : 0 < e &&
                              r + A > D.top + D.minSize.height &&
                              ((a = P.x =
                                  a + D.columnWidths[P.line] + T.padding),
                              P.line++,
                    ...
                    (c = x),
                        ...
                        isNaN(w) ||
                            ...
                            _.setLineDash &&
                                _.setLineDash(Xn(g.lineDash, F.borderDash)),
                            T && T.usePointStyle
                                ? ((m = (w * Math.SQRT2) / 2),
                                  (v = y.xPlus(c, w / 2)),
                                  (b = f + k / 2),
    ...
    function di(t, e, n) {
        ...
        return s || l
            ? Math.min(s ? si(r, t, n) : d, l ? si(o, a, n) : d)
            : "none";
    }
